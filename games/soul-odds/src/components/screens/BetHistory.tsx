...
const EmptyHistory = (props: { onSummon: () => void }) => (
  <div className="mt-8 flex flex-col items-center text-center">
    <div className="relative overflow-hidden">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 scale-[2.5]">
        <Image src="/egypt/Relics/sand_relics_sarcophagus_open_01.png" alt="" width={50} height={50} unoptimized />
      </div>
    </div>
    <p className="font-[600]">No souls weighed yet</p>
    <p className="mt-1 mb-4 text-[#AFAFAF] text-[0.8rem]">Every bet you settle is written here.</p>
...
export const BetHistoryScreen = () => {
  ...
  return (
    <div className="mx-auto container px-4 py-4 pb-32">
      <h2 className="text-2xl font-[500] mb-3">Bet history</h2>
      <p className="text-sm text-white leading-[1.7]">Every soul you&apos;ve weighed, and how the scales fell.</p>
