...
export const RevealStamp = (props: { tone: "win" | "loss" | "neutral"; rotate?: number; className?: string; children: React.ReactNode }) => {
  ...
  return (
    <motion.span
      ...
      className={`inline-block rounded border-2 border-dashed px-2 py-0.5 font-bold text-[11px] uppercase tracking-[0.15em] ${TONE_CLASSES[props.tone]} ${props.className ?? ""}`}
    >
      {props.children}
    </motion.span>
  );
