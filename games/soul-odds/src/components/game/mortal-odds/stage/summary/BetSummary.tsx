      ...
      <div className="gold-gradient mt-auto rounded-2xl p-px">
        <div className="flex flex-col gap-4 rounded-2xl bg-[#0A1412] p-4">
          <div className="flex flex-col gap-2">
            <div className="grid grid-cols-[1fr_auto_auto_auto] gap-4 px-1 text-[10px] text-white/40 uppercase tracking-[0.15em]">
                ...
                >
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="truncate font-semibold text-sm text-white">{row.label.pick}</p>
                    </div>
                  </div>
                  <span className="text-right text-sm text-white/70">{row.odds === null ? "—" : row.odds.toFixed(2)}</span>
                  ...
                  <span className="flex items-center justify-end gap-1 text-right font-bold text-[#F5B83D] text-sm">
                    <CurrencyCoinIcon width={14} height="14" />
