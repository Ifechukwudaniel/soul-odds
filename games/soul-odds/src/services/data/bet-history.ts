...
export const recordBetHistory = async (address: string, entries: BetHistoryEntry[]): Promise<void> => {
...
export const patchBetHistoryStory = async (address: string, patch: Pick<BetHistoryEntry, "id" | "story" | "name">): Promise<void> => {
