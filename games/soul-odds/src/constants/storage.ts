...
// ✦ Bump the version suffix when a stored shape changes, so old entries are ignored.
export const PLAYER_STORAGE_KEY = 'mortal-odds-player:v1';
export const LIFE_STORY_CACHE_PREFIX = 'mortal-odds-life-story:v2:';
