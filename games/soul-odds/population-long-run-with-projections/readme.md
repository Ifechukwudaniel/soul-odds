...
This data package contains the data that powers the chart ["Population"](https://ourworldindata.org/grapher/population-long-run-with-projections?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website.
...
Unit: people  
Source: UN WPP (2024) – with major processing by Our World in Data  

#### How to cite this data

UN WPP (2024) – with major processing by Our World in Data
