  ...
  return (
    <div className="flex h-full flex-col gap-3 overflow-y-auto p-4">
      ...
      <Field
        ...
        placeholder="http://localhost:3000/casino/coinflip/"
        mono={false}
      ...
      <Field
        ...
        onChange={(value) => {
          set('playerPrivateKey', value as SimulatorConfig['playerPrivateKey']);
        }}
      />
      <label className="flex flex-col gap-1">
      ...
      <Field
        ...
        value={config.proxy}
        onChange={(value) => {
          set('proxy', value as SimulatorConfig['proxy']);
        }}
        placeholder="0x…"
      />
      <Field
        ...
        onChange={(value) => {
          set('liquidityVault', value as SimulatorConfig['liquidityVault']);
        }}
        placeholder="0x…"
      />
      <Field
        ...
        value={config.token}
        onChange={(value) => {
          set('token', value as SimulatorConfig['token']);
        }}
        placeholder="0x…"
      />
      <label className="flex flex-col gap-1">
        ...
        <select
          ...
          className={inputClasses}
          onChange={(event) => {
            set('walletStatus', event.target.value as WalletStatusOverride);
          }}
        >
      ...
      <label className="flex flex-col gap-1">
        ...
        <input
          ...
          onChange={(event) => {
            set('indexerLagMs', Number(event.target.value));
          }}
        />
      </label>
      <label className="flex flex-col gap-1">
        ...
        <input
          ...
          className="accent-indigo-500"
          onChange={(event) => {
            set('flashblockLagMs', Number(event.target.value));
          }}
        />
      </label>
