...
const coinBadgeHeads = '/casino/coinflip/coin-badge-heads.webp';
const coinBadgeTails = '/casino/coinflip/coin-badge-tails.webp';
    ...
    <div className="cf-canvas">
      ...
      >
        {Array.from({ length: count }).map((_, i) => {
          ...
          if (phase === 'flipping') {
            classes.push('cf-coin--spinning');
          }
          if (phase === 'landing' || phase === 'settled') {
            classes.push(
              landedHeads ? 'cf-coin--lands-heads' : 'cf-coin--lands-tails',
              phase === 'landing' ? 'cf-coin--landing' : 'cf-coin--settled',
            );
          }
          if (phase === 'settled') {
            classes.push(matched ? 'cf-coin--match' : 'cf-coin--miss');
          }
