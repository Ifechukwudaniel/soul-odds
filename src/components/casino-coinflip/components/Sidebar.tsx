...
import { MAX_COIN_COUNT } from '../lib/coinflip';
import type { CoinflipBet } from '../lib/coinflip';
      ...
      <div className="ck-sidebar__scroll">
        ...
        <div className="cf-slider-row">
          ...
          <Slider
            ...
            value={form.minWins}
            onChange={(e) => {
              setForm({ ...form, minWins: Number(e.target.value) });
            }}
